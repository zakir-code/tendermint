...
func (blockExec *BlockExecutor) ApplyBlock(
	...
	blockExec.logger.Info("ApplyBlock", "Proposer", state.Validators.Proposer, "Validators", state.Validators.Validators)
	blockExec.logger.Info("ApplyBlock", "AppHash", state.AppHash)
	blockExec.logger.Info("block", "Height", block.Height)
	blockExec.logger.Info("block", "TxsLen", len(block.Txs))
	blockExec.logger.Info("block", "Evidence", block.Evidence.Evidence.String())
